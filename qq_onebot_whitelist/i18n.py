...
_TEXT = {
    'en-US': {
        ...
        'help_lines': [
            ...
            '8. Favorites: view merged messages saved from private chat',
        ],
        ...
        'fav_none': 'No favorites yet. Forward a merged message in private chat (without quoting) and it will be saved automatically.',
        ...
        'windows_usage': 'Usage: Analysis windows View; Analysis windows Set 00:30-08:30,12:00-13:00; Analysis windows All day',
    ...
    'zh-CN': {
        ...
        'fav_none': '暂无收藏。私聊转发合并消息给我（不引用），会自动收藏。',
        ...
        'windows_usage': '用法：分析时段 查看；分析时段 设置 00:30-08:30,12:00-13:00；分析时段 全天',
